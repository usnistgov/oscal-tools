...
const TabBar = class {
  constructor(hostRef) {
    ...
    this.ionTabBarChanged = (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionTabBarChanged", 7);
  ...
  render() {
    ...
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.H, { role: "tablist", "aria-hidden": keyboardVisible ? 'true' : null, class: (0,_theme_7670341c_js__WEBPACK_IMPORTED_MODULE_2__.c)(color, {
        [mode]: true,
...
const TabButton = class {
  constructor(hostRef) {
    (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.r)(this, hostRef);
    this.ionTabButtonClick = (0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.e)(this, "ionTabButtonClick", 7);
    /**
  ...
  componentWillLoad() {
    if (this.layout === undefined) {
      this.layout = _ionic_global_00475c3a_js__WEBPACK_IMPORTED_MODULE_1__.c.get('tabButtonLayout', 'icon-top');
    }
  }
  selectTab(ev) {
  ...
  render() {
    ...
    return ((0,_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_88bdeaae_js__WEBPACK_IMPORTED_MODULE_0__.H, { onClick: this.onClick, onKeyup: this.onKeyUp, role: "tab", tabindex: tabIndex, "aria-selected": selected ? 'true' : null, id: tab !== undefined ? `tab-button-${tab}` : null, class: {
        [mode]: true,
